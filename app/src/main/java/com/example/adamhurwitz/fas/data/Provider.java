 ...
 */
package com.example.adamhurwitz.fas.data;
...
public class Provider extends ContentProvider {
    ...
    */
    static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(authority, Contract.PATH_PRODUCTTABLE, PRODUCT);
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            case PRODUCT:
                Log.v(LOG_TAG, "getType :" + Contract.ProductData
                        .CONTENT_TYPE);
                return Contract.ProductData.CONTENT_TYPE;
            default:
        ...
        switch (uriMatcher.match(uri)) {
            case PRODUCT: {
                ...
                cursor = mDbHelper.getReadableDatabase().query(
                        Contract.ProductData.TABLE_NAME,
                        projection,
                        selection,
                        selectionArgs,
                        null,
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (match) {
            case PRODUCT: {
                long _id = db.insert(Contract.ProductData.TABLE_NAME,
                        null, values);
                if (_id > 0)
                    returnUri = Contract.ProductData.buildProductUri(
                            _id);
                else
    ...
    public int update(
        ...
        switch (match) {
            case PRODUCT:
                rowsUpdated = db.update(Contract.ProductData
                                .TABLE_NAME, values,
        ...
        switch (match) {
            case PRODUCT:
                rowsDeleted = db.delete(
                        Contract.ProductData.TABLE_NAME, selection,
                        selectionArgs);
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
            ...
            case PRODUCT:
                ...
                try {
                    for (ContentValues value : values) {
                        long _id = db.insert(Contract.ProductData
